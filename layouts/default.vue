   ...
   <header class="w-64 h-64">
     <div class="w-64 mt-24 ml-2 relative md:fixed">
       <div class="flex">
         ...
         <div>
           <nuxt-link to="/"><h1 class="font-bold">Shota Toshimitsu</h1></nuxt-link>
           <p class="text-xs text-justify">フロントエンドエンジニアのShota Toshmitsuです。Vue.js, Nuxt.jsが大好きです。Laravelも使います。ご依頼はDMからどうぞ。</p>
         </div>
       </div>
       ...
       <!-- scriptでkeyword変数を用意しておく。v-model="keyword"にinputされたワードが入る。 -->
